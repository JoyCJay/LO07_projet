...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 06 juin 2018 à 09:29
...
CREATE TABLE IF NOT EXISTS `contrat` (
  ...
  `list_enfant` varchar(10) NOT NULL,
...
INSERT INTO `contrat` (`id_contrat`, `revenue`, `debut`, `fin`, `id_nounous`, `id_parents`, `evaluation`, `type`, `note`, `nom_p`, `nom_n`, `prenom_p`, `prenom_n`, `jour`, `heure`, `list_enfant`) VALUES
(5, 28, '2018-06-20', '2018-06-21', 107, 102, 'un nounous trÃ¨s patiente et professionnel', 'babysit', 4, 'masson', 'Lehoucq', '', 'celine', '1', '12-16', '4,5'),
(11, 63, '2018-07-07', '2018-07-30', 109, 103, 'non', 'babysit', 0, 'Lamarque', 'Gaule', 'Alex', 'Jennifer', '2,3,4', '10-16', '6'),
(12, 120, '2018-06-08', '2018-06-22', 110, 103, 'non', 'langue', 0, 'Lamarque', 'Lenoir', 'Alex', 'Justine', '3,4', '10-12', '1,7');
...
CREATE TABLE IF NOT EXISTS `enfant` (
  ...
  `id_contrat` int(5) DEFAULT NULL,
  PRIMARY KEY (`id_enfant`),
  KEY `parents_KF_idx` (`parents`),
  KEY `contrat_KF_idx` (`id_contrat`)
...
INSERT INTO `enfant` (`id_enfant`, `prenom`, `parents`, `date_de_naissance`, `restrictions_alimentaires`, `id_contrat`) VALUES
(1, 'colin', 'lam', '1995-02-12', 'non', NULL),
(2, 'matin', 'masson', '1998-05-22', 'non', NULL),
(3, 'ss', 'masson', '2018-05-15', 'non', NULL),
(4, 'colin', 'masson', '1997-07-10', 'non', 5),
(5, 'noa', 'masson', '2018-05-16', 'non', 5),
(6, 'maxime', 'lam', '2008-03-30', 'Allergie au sarrasin (attention! )', 6),
(7, 'Paule', 'lam', '1999-07-21', 'non', NULL);
...
(5, 'solange', 'abc12345', 'SONG', 'Xiaotong', 22, 'troyes', 'normal', 'solangeie@163.com', 767219907, '', 'chinois,englais', 'prudence, sympa et tres patience', '3 ans ', 14, 18, '2018-06-01', '2018-06-30', '1,2,3,4,5', NULL);
...
INSERT INTO `parents` (`id_parents`, `login`, `mot de passe`, `nom_famille`, `ville`, `email`, `portable`, `photo`) VALUES
(103, 'lam', '12345', 'Lamarque', 'Paris', 'lamarque@gmail.com', 638926477, './database/photos/lam'),
(102, 'masson', '12345', 'Masson', 'troyes', 'masson@gmail.com', 743567732, './database/photos/masson');
